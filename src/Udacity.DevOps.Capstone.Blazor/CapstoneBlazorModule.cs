...
public class CapstoneBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(CapstoneResource),
                typeof(CapstoneDomainModule).Assembly,
                typeof(CapstoneDomainSharedModule).Assembly,
                typeof(CapstoneApplicationModule).Assembly,
                typeof(CapstoneApplicationContractsModule).Assembly,
                typeof(CapstoneBlazorModule).Assembly
            );
        });
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles("/Udacity.DevOps.Capstone.Blazor.styles.css");
                }
            );
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new CapstoneMenuContributor());
        });
    }
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(CapstoneBlazorModule).Assembly;
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(CapstoneApplicationModule).Assembly);
        });
    }
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<CapstoneBlazorModule>();
        });
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "Capstone API");
        });
